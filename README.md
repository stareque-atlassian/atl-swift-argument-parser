...
`AtlArgumentParser` uses your properties' names and type information,
...
- [AtlArgumentParser documentation][docs]
- [Getting Started with AtlArgumentParser](https://swiftpackageindex.com/apple/swift-argument-parser/documentation/AtlArgumentParser/gettingstarted)
- [`ParsableCommand` documentation](https://swiftpackageindex.com/apple/swift-argument-parser/documentation/AtlArgumentParser/parsablecommand)

[docs]: https://swiftpackageindex.com/apple/swift-argument-parser/documentation/AtlArgumentParser
...
You can also see examples of `AtlArgumentParser` adoption among Swift project tools:
...
consists of non-underscored declarations that are marked public in the `AtlArgumentParser` module.
...
To use the `AtlArgumentParser` library in a SwiftPM project, 
...
let package = Package(
    ...
    targets: [
        .executableTarget(name: "<command-line-tool>", dependencies: [
            // other dependencies
            .product(name: "AtlArgumentParser", package: "swift-argument-parser"),
        ]),
        // other targets
    ]
)
